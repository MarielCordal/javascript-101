...
var misPeliculasFavoritas = ['Volver al futuro', '9 reinas', 'Toy Story'];
...
1. Los índices de un array pueden especificarse por medio de expresiones que devuelvan un número y valores de variables. Veamos algunos ejemplos:
    ...
    let indiceDeBrasil = 1;
    let brasil = paises[indiceDeBrasil];
...
1. Podés crear arrays usando variables.
    ...
    let miPostreFavorito = 'Flan con dulce de leche';
    let miAnimalFavorito = 'Cocodrilo';
    let miColorFavorito = 'Azul';

    // Declaro un array que va a tener como valores las variables que declaré
    // antes + un string que dice `Dormir mucho`
    let cosasQueMeGustanMucho = [
        miPostreFavorito,
        miAnimalFavorito,
        miColorFavorito,
        'Dormir mucho'
