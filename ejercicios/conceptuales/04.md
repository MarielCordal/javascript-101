...
```javascript
// Hola JavaScript, necesito que crees una cajita llamada `miNumeroFavorito`
...
1. Mostrar por la terminal los siguientes valores `false`, `'Hola'` y `0` usando la misma variable.
